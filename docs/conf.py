...
latex_documents = [
    (master_doc, 'invenio-saml.tex', u'invenio-saml Documentation',
     u'Esteban J. Garcia Gabancho', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-saml', u'invenio-saml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'invenio-saml', u'Invenio-SAML Documentation',
     author, 'invenio-saml', 'Invenio module that provides SAML integration.',
     'Miscellaneous'),
]
